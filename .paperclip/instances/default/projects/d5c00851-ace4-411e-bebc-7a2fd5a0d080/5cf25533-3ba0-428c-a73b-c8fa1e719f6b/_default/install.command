#!/usr/bin/env bash
# install.command — double-click in Finder to install Paperclip on macOS
# This is the same script as install.sh. The .command extension makes it
# double-clickable in macOS Finder (opens Terminal automatically).
